...
Specifics: Git \+ Github \+ Gradle \+ IDE (VSCode/Eclipse/IntelliJ))
...
- Git = Required \(others not allowed\)

- Github  = Required\, but any Git client will work 
...
![bg left width:100px](img/Infrastructure%20Slides_3.png)



![bg right width:100px](img/Infrastructure%20Slides_2.png)

![bg right width:100px](img/Infrastructure%20Slides_1.png)
